            ...
            if (!args[0]) {
                ...
                if (fromRole !== undefined && toRole !== undefined) {
                    ...
                    if (toChannel && fromChannel) {
                        ...
                        message.channel.send("No voice channel found associated with one or more of the roles supplied. Ensure you have set up voice channel roles and that I have permission to view the channel, and try again.").catch();
                    }
                } else {
                    message.channel.send("Incorrect syntax! Correct syntax: f!movevoice [from voice channel role] [to voice channel role]").catch();
                }
